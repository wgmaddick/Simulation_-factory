...
st.set_page_config(layout="wide", page_title="AAT Scheme Performance Engine")
...
with st.sidebar:
    ...
    role = st.selectbox("Active User Role Matrix", ["Scheme Director (GM)", "Claims Officer / Analyst", "Reviewing Specialist"])
    st.markdown("---")
