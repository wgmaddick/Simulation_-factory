...
- There is no lint config or test suite in this repo. "Testing" is manual: upload a CSV (columns `player_name`, `sprint_speed_m_s`, `reload_latency_s`, or their aliases) on the main page, and use Start/Pause/Reset in the Factory Floor sidebar.
